...
const ERROR_PATTERNS: ErrorPattern[] = [
  ...
  { match: /^Financial statement PIN check failed/i,
    replace: () => 'That PIN is wrong. Re-enter your own PIN to unlock this statement.' },
  { match: /Financial statement locked out until\s+(.+)/i,
