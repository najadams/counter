...
const api = {
  ...
  receiptGetConfig: () =>
    ipcRenderer.invoke(IPC_CHANNELS_RECEIPT.RECEIPT_GET_CONFIG, {}),
  receiptSetConfig: (req: ReceiptSetConfigRequest) =>
    ipcRenderer.invoke(IPC_CHANNELS_RECEIPT.RECEIPT_SET_CONFIG, req),
};
